...
public interface FuncionarioRepository extends JpaRepository<Funcionario, Integer> {// Generics
    List<Funcionario> findByCargo(Cargo cargo); // Filtrar os funcionarios que possuem o cargo new*
    List<Funcionario> findByFotoIsNull(); // Filtrar funcionario sem foto definida new
